...
RUN apt update && apt install -y git python3-pip python3-colcon-common-extensions ros-humble-joy ros-humble-ament-cmake portaudio19-dev ros-humble-depthai-ros build-essential swig libpulse-dev libasound2-dev
